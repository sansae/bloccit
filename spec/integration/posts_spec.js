...
describe("routes : posts", () => {
  ...
  // define the guest user context; guests simply visit the site, and are not signed in, and as such, their access privileges should only include the ability to see topics and posts
