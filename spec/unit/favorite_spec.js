  ...
  describe("#setUser()", () => {
    it("should associate a favorite and a user together", (done) => {
      ...
      .then((favorite) => {
        ...
        //confirm it was created for this.user
        expect(favorite.userId).toBe(this.user.id);
        User.create({
        ...
        .then((newUser) => {
          // change the favorite's user reference for newUser
  ...
  describe("#getUser()", () => {
    it("should return the associated user", (done) => {
      ...
      .then((favorite) => {
        favorite.getUser()
        .then((user) => {
          // ensure the right user is returned
  ...
  describe("#setPost()", () => {
    it("should associate a post and a favorite together", (done) => {
      ...
      .then((favorite) => {
        ...
        .then((newPost) => {
          // check favorite not associated with newPost
